            ...
            if isinstance(img, Image.Image):
                ...
                if req.save_outputs and req.save_format == "png":
                    try:
                        ...
                        # Save metadata to Gallery DB (fire-and-forget)
                        try:
                            _gallery_save = _import("studio_gallery", "save_metadata_for_image")
                            if _gallery_save and _parsed_infotexts and i < len(_parsed_infotexts):
                                _gallery_save(str(fpath), _parsed_infotexts[i], _parsed_settings)
                        except Exception:
                            pass
