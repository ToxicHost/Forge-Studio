...
def _meta_row_values(meta, content_hash="", image_id=None, float_path=""):
...
_META_INSERT_SQL = """
    INSERT OR REPLACE INTO image_metadata (
        ...
        sampler, scheduler, model, model_hash, denoising,
        width, height, clip_skip, hires_upscaler, hires_upscale,
        raw_infotext, created_at, float_path
    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
"""
...
def save_metadata_by_hash(content_hash, infotext, settings=None, filepath=None, float_path=""):
    ...
    try:
        ...
        db.execute(_META_INSERT_SQL, _meta_row_values(meta, content_hash, image_id, float_path or ""))
        db.commit()
    except Exception as e:
