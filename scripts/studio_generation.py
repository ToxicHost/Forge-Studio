...
# AD pipeline — extracted to studio_autodetailer in PR 1 of the
# studio-native ADetailer migration. Underscore aliases are re-exported
# so existing _import("studio_generation", "_build_native_ad_dicts") /
# "_run_studio_ad" call sites keep resolving without churn.
try:
    from scripts.studio_autodetailer import (
        ...
        _run_studio_ad,
        _get_ad_model_mapping,
        _get_ad_device,
        _match_detection_to_region,
    )
except ImportError:
...
# ADetailer pipeline lives in scripts/studio_autodetailer.py — imported
# above as _build_native_ad_dicts / _run_studio_ad / _HAS_AD_LIBS /
# _get_ad_model_mapping / _get_ad_device / _match_detection_to_region.
